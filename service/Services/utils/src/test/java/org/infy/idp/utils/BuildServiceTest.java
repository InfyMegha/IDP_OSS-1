...
/**
 * BuildServiceTest is a test class for BuildService
 *
 * @see org.infy.idp.utils.BuildService
 * 
 */
...
public class BuildServiceTest extends PackageTestCase {
	...
	/**
	 * Test for method BuildService().
	 * 
	 * @throws Throwable Tests may throw any Throwable
	 *
	 * @see BuildService#BuildService()
	 * 
	 * 
	 */
	@Test
	...
	/**
	 * Test for method
	 * getBuildLogs(com.offbytwo.jenkins.JenkinsServer,java.lang.String,int).
	 * 
	 * @throws Throwable Tests may throw any Throwable
	 *
	 * @see BuildService#getBuildLogs(com.offbytwo.jenkins.JenkinsServer,java.lang.String,int)
	 * 
	 * 
	 */
	@Test
	public void testGetBuildLogs0() throws Throwable {
		BuildService testedObject = new BuildService();
	...
	/**
	 * Test for method
	 * getBuildStatus(com.offbytwo.jenkins.JenkinsServer,java.lang.String,int,
	 * long).
	 * 
	 * @throws Throwable Tests may throw any Throwable
	 *
	 * @see BuildService#getBuildStatus(com.offbytwo.jenkins.JenkinsServer,java.lang.String,int,long)
	 * 
	 * 
	 */
	@Test
	public void testGetBuildStatus0() throws Throwable {
		BuildService testedObject = new BuildService();
		URI serverUri = new URI("string_0");
	...
	@Test
	public void testGetBuildLogs() throws Throwable {
		...
		JenkinsServer jenkins = new JenkinsServer(new URI(jenkinsurl), userid, password);

		String jobName = idpjson.getBasicInfo().getApplicationName() + "_" + idpjson.getBasicInfo().getPipelineName();

		int buildNumber = 3;

		testedObject.getBuildLogs(jenkins, jobName, buildNumber);
