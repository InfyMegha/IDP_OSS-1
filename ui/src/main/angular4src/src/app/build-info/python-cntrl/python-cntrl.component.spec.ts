...
describe('PythonCntrlComponent', () => {
  ...
  it('codeAnalysisSonar()', () => {
	  ...
	  var a = component.codeAnalysisSonar();
    expect(a).toBeFalsy();
  });

  it('codeAnalysisEmptyPaTrue() ', () => {
	
    var a = component.codeAnalysisEmptyPaTrue();
   ...
   it('codeAnalysisEmptyPaTrue() ', () => {
    ...
    var a = component.continuecontrolFalse();
    ...
    var a = component.continuecontrolTrue();
    ...
    var a = component.unitTestingOff();
  ...
  it('targetEnvironmentUnitTestingOff() ', () => {
    ...
    var a = component.targetEnvironmentUnitTestingOff();
