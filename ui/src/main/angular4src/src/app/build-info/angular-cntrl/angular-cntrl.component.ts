...
export class AngularCntrlComponent implements OnInit {
  ...
  checkCompile() {
    ...
    if (this.tempObject.modules[0].build === 'on') {
      if (this.buildInfo.modules[0].buildValue == null ||
    ...
    for (let i = 0; i < this.buildInfo.modules.length; i++) {
      ...
      if (this.buildInfo.modules[i].jsonPath !== null && this.buildInfo.modules[i].jsonPath !== undefined &&
        ...
        compile = 'on';
           ...
           if (this.buildInfo.modules[i].angularBuildCommand !== null && this.buildInfo.modules[i].angularBuildCommand !== undefined &&
