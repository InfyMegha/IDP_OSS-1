...
export class IdpService {
  constructor(
    ...
    //  private ShowConfigurationsComponent:ShowConfigurationsComponent
  ) {
    // this.initMain();
  }
      ...
      .then(response => {
        try {
          if (response) {
            ...
            // this.idpdataService.subscriptionServerURL = "https://idplinv03:8090/subscription";
            ...
            console.log(this.idpdataService.serverUrl);
            console.log(this.idpdataService.uName);
