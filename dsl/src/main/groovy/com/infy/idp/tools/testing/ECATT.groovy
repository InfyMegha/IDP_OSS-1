...
/**
 *
 * This class has the method to add ECATT testing tool
 *
 */
class ECATT {
    ...
    /*
     * This method is used to add the steps to configure ECATT
     */
    ...
    /*
     * This method is used to create the test job consisting eCAAT configurations
     */
