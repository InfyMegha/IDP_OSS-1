...
public class NexusDetails {
	...
	public  List<DeployArtifact> getNexus(String idpData, String appData,String applicationName, String pipelineName) {
        ...
        try{
        	if(idp.has("buildInfo") && idp.getJSONObject("buildInfo").has("artifactToStage") &&  idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").has("artifactRepoName") &&!idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase("na")  &&!idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase("")){
				 userName = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoUsername");
				 passWord = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoPassword");
				 nexusURL = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoURL");
				 repoName= idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoName");
					System.out.println("3");
				 artifact=true;
				
        	}else if((idp.has("buildInfo") && idp.getJSONObject("buildInfo").has("artifactToStage") &&  (!idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").has("artifactRepoName") || idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase(" ")) ||(idp.has("buildInfo") && !idp.getJSONObject("buildInfo").has("artifactToStage") ))){
        	if(app.has("artifactToStage") && app.getJSONObject("artifactToStage").has("artifactRepoName") && !app.getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase("na") && !app.getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase("")){
        		userName = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoUsername");
				 passWord = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoPassword");
				 nexusURL = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoURL");
				 repoName= idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoName");
        	...
        	if(idp.getJSONObject("code").getString("technology").equalsIgnoreCase("J2EE/Ant")&& app.has("artifactToStage") && app.getJSONObject("artifactToStage").has("artifactRepo")&& !app.getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase("na") && !app.getJSONObject("artifactToStage").getString("artifactRepoName").equalsIgnoreCase("")){
        		userName = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoUsername");
				 passWord = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoPassword");
				 nexusURL = idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoURL");
				 repoName= idp.getJSONObject("buildInfo").getJSONObject("artifactToStage").getJSONObject("artifactRepo").getString("repoName");
                ...
                if(artifact){
				String urlToHit = "http://" + nexusURL + "/service/siesta/rest/beta/search?repository="+repoName +"&group="+ applicationName + "&name=" + pipelineName;
 ...
 * @throws SQLException
 */
public List<DeployArtifact> getArtifact(String applicationName,String pipelineName,String releaseNumber,String environmentName) throws SQLException {
	...
	try{
		...
		int releaseId = artifactHistory.getReleaseId(applicationName, pipelineName, 
				releaseNumber, "on");
